...
print(f'Train Accuracy on full embeddings: {train_accuracy_full:.2f}%, Test Accuracy on full embeddings: {test_accuracy_full:.2f}%')
...
print(f'Train Accuracy on reduced embeddings: {train_accuracy_reduced:.2f}%, Test Accuracy on reduced embeddings: {test_accuracy_reduced:.2f}%')