...
The orchestrator (pages/train/universal_train.py) auto-discovers this file
via a pages/*/train.py glob and calls get_training_pairs() if present.
...
The orchestrator will:
  1. Scan pages/*/train.py for all installed modules
...
def get_training_pairs(cfg, text_embedder, status_callback=None):
    ...
    chunk_embeddings : np.ndarray of shape [num_chunks, embedding_dim]
        ...
        For text-native modules (like web_search) embed the file content
